    ...
    render() {        
        ...
        return (
            <div className="fancy">
                ...
                <SessionTable sessions={this.state.sessions} onEnterSession={this.onEnterSession} onCreateSession={this.onCreateSession} currentSession={this.state.openSession} />
